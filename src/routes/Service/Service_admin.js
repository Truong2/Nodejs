...
router.get('/get-list-service', service_service.get_list_sevice_service)
router.get('/list-service', service_service.listSevice)
...
router.get('/get-list-service-by-type-service', func.checkToken, service_service.get_list_service_by_type_service)
